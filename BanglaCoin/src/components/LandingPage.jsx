...
import landlogo from "../../images/landlogo.png";
import { Loader } from ".";
...
const LandingPage = () => {
  const { connectWallet, disconnectWallet, currentAccount, formData, sendTransaction, handleChange } =
  ...
  const shortenAddress = (address = "") => address.length > 10? `${address.slice(0, 9)}...${address.slice(-4)}`: address;
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex flex-col md:flex-row items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-1 justify-start items-start flex-col md:mr-10">
          ...
          <img src={landlogo} alt="logo" className='w-32'/>Send Crypto <br /> across the world
          </h1>
